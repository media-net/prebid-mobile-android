...
import com.android.adsdk.events.LoggingEvents
import com.android.adsdk.model.StoredConfigs
import com.android.adsdk.model.sdkconfig.SdkConfiguration
import com.android.adsdk.network.NetworkComponentFactory
import com.android.adsdk.network.SDKConfigSyncWorker
import com.android.adsdk.network.ServerApiService
import com.android.adsdk.network.repository.ConfigRepoImpl
import com.android.adsdk.network.repository.IConfigRepo
import com.android.adsdk.utils.ConfigSerializer
import com.android.adsdk.utils.Constants.DATA_STORE_FILE_NAME
import com.android.adsdk.utils.MapperUtils.mapLogLevelToPrebidLogLevel
...
internal object AdSDKManager {
    ...
    fun isSubjectToGDPR(): Boolean {
        return TargetingParams.isSubjectToGDPR() ?: false
    }
