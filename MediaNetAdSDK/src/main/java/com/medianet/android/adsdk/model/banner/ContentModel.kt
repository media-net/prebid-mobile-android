...
class ContentModel {
     ...
     */
    var producerObject: ProducerModel? = null

    fun addData(data: DataModel) = dataModels.add(data)
    fun addDataList(dataList: List<DataModel>) = dataModels.addAll(dataList)
    fun clearDataList() = dataModels.clear()
